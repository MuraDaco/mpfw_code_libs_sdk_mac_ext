...
#ifndef VHW_PPH_OBJS_H
#define VHW_PPH_OBJS_H
...
//#define PPH_CLASS_DEF   vhwPphObjs_t
#define PPH_CLASS_DEF

//#define DEF_H___PPH_BUTTON(name)            static pphButton_t pph_##name;
//#define DEF_H___PPH_BUTTON_X(name)          name pphButton_t pph_##name;
//
//#define DEF_CPP_PPH_BUTTON(class, name)     pphButton_t class::pph_##name;
//#define OBJ_PPH_BUTTON(class, name)         class::pph_##name
//#define DEF_CPP_PPH_BUTTON_STD(name)        pphButton_t PPH_CLASS_DEF::pph_##name;
//#define OBJ_PPH_BUTTON_STD(name)            PPH_CLASS_DEF::pph_##name
...
//public:
//
//    static DEF_H___PPH_BUTTON   (BUTTON_UP)
//    static DEF_H___PPH_BUTTON   (BUTTON_TEST)
//    static DEF_H___PPH_BUTTON   (BUTTON_XXX)
//
//};
