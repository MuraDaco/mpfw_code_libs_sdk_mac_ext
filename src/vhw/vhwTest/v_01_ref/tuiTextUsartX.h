 ...
 * tuiTextUsartX.h
 *
 *  Created on: Oct, 4th 2024
 *      Author: Marco Dau
 */
 
#ifndef TUI_TEXT_USART_X_H
#define TUI_TEXT_USART_X_H

#include "tuiBaseCntnrX.h"
#include "dtyStufX.h"

class tuiTextUsartX_t : public tuiBaseCntnrX_t    {

public:

    tuiTextUsartX_t (const char* p_strName, box_t  p_box, dtyStufX_t* p_pCntnr);
    //tuiTextUsartX_t (const char* p_strName, box_t* p_pBox, dtyStuf_t* p_pCntnr);
