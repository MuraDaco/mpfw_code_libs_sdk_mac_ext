...
class tuiUnitDebug_t :    public tuiUnitAbstract_t
{

public:
    tuiUnitDebug_t       (const char* p_strName  ,dtyUint8_t* p_pDtyStatus = nullptr   );
...
protected:
    ...
    //bool selectTst              (tuiGraphicAbstract_t* p_this) override;  // to be deleted
