...
#ifndef TUI_UNIT_EBOX_H
#define TUI_UNIT_EBOX_H
...
class tuiUnitEbox_t :    public tuiUnitAbstract_t
{

public:
    tuiUnitEbox_t       (const char* p_strName  ,dtyBaseArray_t& p_rDtyStr   );
...
protected:
    ...
    void vEventHndlKey_del	            (tuiGraphicAbstract_t* p_this) override;
    void vEventHndlKey_backSpace	    (tuiGraphicAbstract_t* p_this) override;
    void vEventHndlKey_typeChar	        (tuiGraphicAbstract_t* p_this) override;
...
private:
    ...
    [[maybe_unused]] dtyBaseArray_t& g_rDtyStr;
    // --------------------- Specific Data section - END

};


#endif 	// TUI_UNIT_EBOX_H
