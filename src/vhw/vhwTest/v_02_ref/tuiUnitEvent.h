...
#ifndef TUI_UNIT_EVENT_H
#define TUI_UNIT_EVENT_H

class tuiGraphicAbstract_t; // cross dependency -> #include "tuiGraphicAbstract.h"

class tuiUnitEvent_t {

public:
    // --------------------- Events handler section - START
	// ..................... Events handler: functions
    virtual void vEventHndlKey_down	        ([[maybe_unused]] tuiGraphicAbstract_t* p_this) {};
