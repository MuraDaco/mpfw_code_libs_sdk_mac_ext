...
#ifndef TUI_UNIT_LIST_DEBUG_H
#define TUI_UNIT_LIST_DEBUG_H
...
class tuiUnitListDebug_t :    public tuiUnitListAbstract_t
{

public:
    tuiUnitListDebug_t       (const char* p_strName  ,tuiGraphicUnit_t* p_childrenSet = nullptr  );
